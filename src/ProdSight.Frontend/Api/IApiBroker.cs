...
public interface IApiBroker
{
    ...
    Task<ICollection<ProdSight.Api.Shared.DTOs.DocumentsModule.Folders.GetRootFolders.Folder>> GetRootFoldersAsync(CancellationToken cancellationToken = default);

    Task<FolderDetails> GetFolderDetailsAsync(Guid id,
        CancellationToken cancellationToken = default);
    Task<ICollection<ProdSight.Api.Shared.DTOs.DocumentsModule.Folders.GetChildren.Folder>> GetChildrenFoldersAsync(Guid parentId, CancellationToken cancellationToken = default);
